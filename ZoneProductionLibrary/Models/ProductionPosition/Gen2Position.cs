...
public class Gen2ProductionPosition : IProductionPosition
{
    ...
    [
        ...
        ("Dome - GEN2", "Dome", 12),
        ("REWORK - GEN2", "Rework", 13),
        ("DETAIL - GEN2", "Detail", 14),
        ("REWORK - GEN 2 - POST DETAIL", "Rework - Post Detail", 15),
        ("SALES PROHO - GEN2", "Sales ProHo", 16),
        ("REWORK - GEN 2 - POST SALES PROHO", "Rework - Post ProHo", 17)
    ];
